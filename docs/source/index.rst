...
================================================
Welcome to pamtraRadarSimulator's documentation!
================================================

:Release: |version|
:Date: |today|

pamtraRadarSimulator is the Pamtra Radar Simulator. It simulates a Doppler spectrum based on the backscattering of arbritrary hydrometeors..

Note that pamtraRadarSimulator only supports Python version >=3.5.
...
You can start using pamtraRadarSimulator in python with ::
...
Provides Routines
*****************
.. automodule:: pamtraRadarSimulator.core
    :members:
    :undoc-members:
    :inherited-members:
    :show-inheritance:
